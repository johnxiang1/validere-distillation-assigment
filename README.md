...
- **Blend_Two_Crude_Oils.py** is a script that needs to input first type of Crude Oil and Volume and the second type of Crude Oil and volume, and it will then return the distillation profile of the mixture of two oils
